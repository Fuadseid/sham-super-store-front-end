...
import "./BestSellerHomeRenovation.scss";
import { useSelector } from "react-redux";
import { useGetbestSellerQuery } from "../../../stores/apiSlice";

const BestSellerHomeRenovation = () => {
  ...
  const bestSeller = bestselling?.data.config[8]?.products;
...
/*   const products = [
    ...
    },
    {
      ...
      name: "Luxury Watch",
      image:
        "https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=150&h=150&fit=crop",
      currentPrice: 899.0,
      isOnSale: false,
    },
    {
    ...
    <div className="best-sellers-section">
      <div className={isRTL ? "rtl" : "ltr"}>
        <h2 className="section-title">
          {t("home.bestSellerHomeRenovation.title")}
        </h2>
      </div>
      ...
      <div className="products-swiper-container">
        <button
          ...
          aria-label={t(
            "home.bestSellerHomeRenovation.navigation.previousSlide"
          )}
        >
          <ChevronLeft />
        </button>
        <button
          ...
          disabled={isEnd}
          aria-label={t("home.bestSellerHomeRenovation.navigation.nextSlide")}
        >
          <ChevronRight />
        </button>
                ...
                <div className="product-image-container">
                  ...
                  {product.is_on_sale && (
                    <div className="sale-banner">
                      <span>{t("home.bestSellerHomeRenovation.sale")}</span>
                    </div>
                  )}
...
export default BestSellerHomeRenovation;
