...
const BestSellerPhones = () => {
  ...
  const bestSeller = bestselling?.data.config[4]?.products;
  ...
  return (
    <div className="best-sellers-section">
      <div className={isRTL ? "rtl" : "ltr"}>
        <h2 className="section-title">{t("home.bestSellerPhones.title")}</h2>
      </div>
      ...
      <div className="products-swiper-container">
        <button
          ...
          aria-label={t("home.bestSellerPhones.navigation.previousSlide")}
        >
          <ChevronLeft />
        </button>
        <button
          ...
          disabled={isEnd}
          aria-label={t("home.bestSellerPhones.navigation.nextSlide")}
        >
          <ChevronRight />
        </button>
                ...
                <div className="product-image-container">
                  ...
                  {product.is_on_sale && (
                    <div className="sale-banner">
                      <span>{t("home.bestSellerPhones.sale")}</span>
                    </div>
                  )}
