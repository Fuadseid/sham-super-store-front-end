    ...
    return (
        <div className="best-sellers-section">
            <div className={isRTL ? 'rtl' : 'ltr'}>
                <h2 className="section-title">{t('home.bestSellerKitchen.title')}</h2>
            </div>
            ...
            <div className="products-swiper-container">
                <button
                    ...
                    aria-label={t('home.bestSellerKitchen.navigation.previousSlide')}
                >
                    <ChevronLeft />
                </button>
                <button
                    ...
                    disabled={isEnd}
                    aria-label={t('home.bestSellerKitchen.navigation.nextSlide')}
                >
                    <ChevronRight />
                </button>
...
export default BestSellerKitchen;