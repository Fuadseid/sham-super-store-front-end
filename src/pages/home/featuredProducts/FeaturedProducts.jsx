...
const FeaturedProducts = () => {
  ...
  useEffect(() => {
    if (featuredProducts) {
      setFeaturedProductsData(featuredProducts?.data.data);
    }
  }, [featuredProducts]);
  console.log("featured", featuredProductsData);
    ...
    <div className="featured-products-section">
      ...
      <div className="products-swiper-container">
        ...
        <button
          ...
          aria-label={t("home.featuredProducts.navigation.previousSlide")}
        >
          <ChevronLeft />
        </button>
        ...
        <button
          ...
          disabled={isEnd}
          aria-label={t("home.featuredProducts.navigation.nextSlide")}
        >
          <ChevronRight />
        </button>
                ...
                <div className="product-image-container">
                  ...
                  {product.isOnSale && (
                    <div className="sale-banner">
                      <span>{t("home.featuredProducts.sale")}</span>
                    </div>
                  )}
