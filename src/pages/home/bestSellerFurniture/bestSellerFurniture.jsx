...
const BestSellerFurniture = () => {
    ...
    const bestSeller = bestselling?.data.config[2]?.products;
    ...
    return (
        <div className="best-sellers-section">
            <div className={isRTL ? 'rtl' : 'ltr'}>
                <h2 className="section-title">{t('home.bestSellerFurniture.title')}</h2>
            </div>
            ...
            <div className="products-swiper-container">
                <button
                    ...
                    aria-label={t('home.bestSellerFurniture.navigation.previousSlide')}
                >
                    <ChevronLeft />
                </button>
                <button
                    ...
                    disabled={isEnd}
                    aria-label={t('home.bestSellerFurniture.navigation.nextSlide')}
                >
                    <ChevronRight />
                </button>
                                ...
                                <div className="product-image-container">
                                    ...
                                    {product.is_on_sale && (
                                        <div className="sale-banner">
                                            <span>{t('home.bestSellerFurniture.sale')}</span>
                                        </div>
                                    )}
...
export default BestSellerFurniture;